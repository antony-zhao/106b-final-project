...
def main(args):
    ...
    def eval(ppo_network, eval_env):
        ...
        while not done:
            ...
            action, _ = ppo_network.policy_network.policy_fn(obs)
    ...
    with torch.device(device):
        ...
        for i in range(args.timesteps // (args.num_envs * args.rollout_length)):
            ...
            metrics = train_rnd(rollout, ppo_network, rnd, ppo_opt, rnd_opt, args.minibatch_size, args.num_epochs, device, rnd_reward_coef=0)
            ...
            if i % 10 == 0:
                eval_reward = eval(ppo_network, eval_env)
                print(eval_reward)
